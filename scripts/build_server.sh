...
sed -i'.backup' 's/data-server-base=\"https:\/\/oranguru\.com\/\"/data-server-base=\"\"/' index.html icon-*.html help.html
sed -i'.backup' 's/data-location=\"local\"/data-location=\"server\"/' send.html
sed -i'.backup' 's/\(<a tabindex="0" href="https:\/\/github\.com\/dwilding\/oranguru"\)/<a tabindex="0" href="https:\/\/snapcraft.io\/oranguru" target="_blank">Linux snap<\/a> • \1/' help.html
rm *.backup
cat <<EOF > .htaccess
